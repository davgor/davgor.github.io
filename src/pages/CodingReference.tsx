    ...
    <>
      ...
      <BlogCard
        ...
        content={[
          ...
          'The architecture uses secure IPC communication between the main Node.js process and the React renderer, with full context isolation and TypeScript throughout. Cross-platform support for Windows, macOS, and Linux (maybe—local use case has me doing it on Windows).',
