  ...
  return (
    <BlogCard
      ...
      content={[
        ...
        {
          type: 'html',
          content: `<h6><b>Methods of contact</b></h6><ul><li><b>Phone:</b> 515-864-6382 (preferred)</li><li><b>Email:</b> davgor4@gmail.com</li><li><a href="https://www.linkedin.com/in/davgor4/">linkedin.com/in/davgor4/</a></li></ul>`,
        },
      ]}
    />
  );
