        ...
        paragraphs: [
          {
            ...
            text: "After a month of being a staff SDET at Onebrief, we were expanding rapidly. I had just finished hiring the director of quality, working with senior leadership to fill the role, and there was still some ambiguity across the organization on my team's role in day-to-day life. So I would take over officially as the engineering manager for my team, train my replacement, and work on rooting my team's reputation in the organization, as well as having the authority to implement a quality strategy for my team and the organization to follow.",
          },
          {
        ...
        paragraphs: [
          {
            ...
            text: 'Onebrief was just starting to build out their QA organization, and I was hired to help establish the QA embedded processes, as well as help build out the higher-end test automation suites. When I was hired they had a whopping 50 test cases they were running on CI, and 200 in a regression suite. These had a massive 75% flake rate.',
          },
          {
            title: 'Team Odyssey',
          ...
          },
          {
            ...
            text: 'One of the biggest issues I encountered when I first got to Onebrief was a lack of confidence in the test automation. This was due to a combination of a high flake rate, and a lack of understanding of how to use the test automation effectively and efficiently. To combat this I implemented a concept I first saw at Lyft called shadowing, where you would keep running end-to-end tests that are flaky, failing, or broken. This way you can collect metrics on the failing tests without blocking PRs or regression suites. After fixing, I took the 250 failing test cases and rewrote them using a series of implicit waits and visual waits, decreasing the flake rate from 75% to sub 1%, and increasing confidence in the test automation, which led to a much higher utilization of the test automation, and a much higher bug catch rate.',
          },
          {
    ...
    roles: [
      {
        ...
        paragraphs: [
          {
            title: '',
            text: "Lyft was my first breakthrough into a big tech organization. Here I was hired to be a software developer in test, with the core tech stack being Kotlin/Espresso for Android testing, and Swift/XCUITest for mobile testing. As SDETs for Lyft we were not only charged with building and expanding upon the mobile testing frameworks, but also leading the charge for quality assurance on an individual project level. We would be assigned to a specific project, and then we would create a comprehensive test plan to be manually tested through the project's development.",
          },
          {
            title: '',
            text: 'This iterative approach, known as <a href="https://www.testim.io/blog/shift-left-testing-guide/">Shift Left Testing</a>, allowed us to create an extensive test plan, and keep the project\'s quality high through the whole development cycle. Once a project was completed, we would assess the project for regression tests, and add them to our weekly release testing cycle. From there we would begin to automate our tests.',
          },
          {
            title: '',
    ...
    roles: [
      {
        ...
        paragraphs: [
          {
            title: '',
            text: 'After working with the QA team for several years at this point, I transitioned over to the QA department as a full-fledged QA. I was assigned to the forms team, and was given a small team of contractors to help write up automated tests, and improve the QA coverage on the forms team. During this time, I helped train my QAs on how to use ReadyAPI to create automated API tests that would request a form, and do a pixel-by-pixel comparison with the template to ensure that the forms generated matched with the requested design. After working with the team for a few months I built out a series of documents that helped standardize our workflow, and dramatically improved the efficiency of the team, to such an extent that I no longer needed to request 5 contractors for the forms team, eventually rolling off 2 forms QAs. By the time I left the role, I was able to leave without the role needing to be backfilled, and it was taken over by one of the contractors I trained.',
          },
        ],
        achievements: {
          title: 'Achievements',
          list: [
            ...
            "Over the course of 5 months, I was able to improve the team's efficiency to the point where we could roll off 2 contractors, allowing them to transition to more in-need sections of the organization.",
          ],
        },
      },
      {
