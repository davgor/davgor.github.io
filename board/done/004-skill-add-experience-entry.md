...
Add a project skill so an agent can interview for work-history details and write structured entries into `src/data/jobs.ts` (new employers, new roles, or expanding existing ones), matching existing voice, ordering, and test updates.
...
- [x] Skill covers expanding an existing job/role (add paragraphs, achievements, restructure thin entries)
